...
<video id="homebrew_install_vid" class="video-js" controls preload="no" width="426" height="240" data-setup="{responsive: true}">
	<source src="https://p.ihateani.me/cerxeavc.mp4" type="video/mp4" />
	<p class="vjs-no-js">
...
{% capture images %}
	https://p.ihateani.me/cdsquggy.png
{% endcapture %}
...
{% capture images %}
	https://p.ihateani.me/pbjxgnzu.gif
{% endcapture %}
{% include gallery images=images caption="Remote - WSL" cols=1 %}
...
{% capture images %}
	https://p.ihateani.me/kpjhhkkm.gif
{% endcapture %}
...
{% capture images %}
	https://p.ihateani.me/xmhvdbyu.png
{% endcapture %}
...
{% capture images %}
	https://p.ihateani.me/kqolciuc.png
{% endcapture %}
...
{% capture images %}
	https://p.ihateani.me/mlashzri.png
{% endcapture %}
...
{% capture images %}
	https://p.ihateani.me/mtqorces.gif
{% endcapture %}
...
{% capture images %}
	https://p.ihateani.me/qpkhfswk.gif
{% endcapture %}
...
<video id="github-new-repo" class="video-js" controls preload="no" width="640" height="360" data-setup="{responsive: true}">
	<source src="https://p.ihateani.me/uzomrkrx.mp4" type="video/mp4" />
	<p class="vjs-no-js">
		To view this video please enable JavaScript, and consider upgrading to a
		web browser that
		<a href="https://videojs.com/html5-video-support/" target="_blank"
...
{% capture images %}
	https://p.ihateani.me/asqjkyxf.gif
{% endcapture %}
...
<video id="github-vscode-fd-exists" class="video-js" controls preload="no" width="480" height="360" data-setup="{responsive: true}">
	<source src="https://p.ihateani.me/wdlxsjjq.mp4" type="video/mp4" />
	<p class="vjs-no-js">
		To view this video please enable JavaScript, and consider upgrading to a
		web browser that
		<a href="https://videojs.com/html5-video-support/" target="_blank"
...
<video id="github-vscode-fd-checkout" class="video-js" controls preload="no" width="480" height="360" data-setup="{responsive: true}">
	<source src="https://p.ihateani.me/qitwmtob.mp4" type="video/mp4" />
	<p class="vjs-no-js">
		To view this video please enable JavaScript, and consider upgrading to a
		web browser that
		<a href="https://videojs.com/html5-video-support/" target="_blank"
...
<video id="github-vscode-clone" class="video-js" controls preload="no" width="480" height="360" data-setup="{responsive: true}">
	<source src="https://p.ihateani.me/zxoleuzs.mp4" type="video/mp4" />
	<p class="vjs-no-js">
		To view this video please enable JavaScript, and consider upgrading to a
		web browser that
		<a href="https://videojs.com/html5-video-support/" target="_blank"
...
<video id="github-vscode-gitignore" class="video-js" controls preload="no" width="480" height="360" data-setup="{responsive: true}">
	<source src="https://p.ihateani.me/jwecruts.mp4" type="video/mp4" />
	<p class="vjs-no-js">
		To view this video please enable JavaScript, and consider upgrading to a
		web browser that
		<a href="https://videojs.com/html5-video-support/" target="_blank"
...
{% capture images %}
	https://p.ihateani.me/zpzcdvck.gif
{% endcapture %}
...
{% capture images %}
	https://p.ihateani.me/tbgmtidf.gif
{% endcapture %}
...
{% capture images %}
	https://p.ihateani.me/mexnhtvp.png
{% endcapture %}
...
{% capture images %}
	https://p.ihateani.me/xrvsisul.gif
{% endcapture %}
...
{% capture images %}
	https://p.ihateani.me/cluzjbfo.gif
{% endcapture %}
...
{% capture images %}
	https://p.ihateani.me/cntmfean.png
{% endcapture %}
...
<video id="git-conflict-resolve" class="video-js" controls preload="no" width="480" height="360" data-setup="{responsive: true}">
	<source src="https://p.ihateani.me/vdnbjhsp.mp4" type="video/mp4" />
	<p class="vjs-no-js">
		To view this video please enable JavaScript, and consider upgrading to a
		web browser that
		<a href="https://videojs.com/html5-video-support/" target="_blank"
